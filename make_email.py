...
def generate_email_html(arxiv_content, github_content, hackernews_content, reddit_content):
    email_html = f"""
    <html>
    <head>
        <style>
    ...
    <body>
        ...
        <table class="nav-table">
            ...
            <tr>
                <td>
                    1. <a href="mailto:#arxiv">ArXiv Papers</a><br>
                    2. <a href="mailto:#github">GitHub Repositories</a><br>
                    3. <a href="mailto:#hackernews">Hacker News</a><br>
                    4. <a href="mailto:#reddit">Reddit Discussions</a>
                </td>
            </tr>
        </table>

        <!-- ArXiv Section -->
        <table width="100%" id="arxiv">
            <tr>
            ...
            <tr>
                <td class="back-to-top">
                    <a href="mailto:#top">Back to Top</a>
                </td>
            </tr>
        </table>

        <!-- GitHub Section -->
        <table width="100%" id="github">
            <tr>
                <td class="section-title">
